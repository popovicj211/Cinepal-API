...
(7, 'SciFi', 1, '2020-04-25 04:06:04', NULL),
...
(64, '8a662c4cd8df28eeda49c30da8bcb92c_1607377262.jpg', '2020-12-07 20:41:02', '2020-12-07 20:41:02'),
(65, '38550e6ffde6df7c36680aa1ac11906f_1607377357.jpg', '2020-12-07 20:42:37', '2020-12-07 20:42:37');
...
(57, 'Bloodshot', 'Bloodshoooooooooooot', '2021-03-16 17:30:00', 125, 1, 65, '2020-12-07 20:42:37', '2020-12-15 22:57:00');
...
(74, 57, 11, '2020-12-15 22:33:16', NULL),
(75, 57, 12, '2020-12-15 22:33:16', NULL),
(77, 57, 3, '2020-12-15 22:57:00', '2020-12-15 22:57:00');
...
(81, 57, 3, '2020-12-07 20:42:37', '2020-12-15 22:33:16'),
(99, 57, 9, '2020-12-15 22:33:16', NULL),
(100, 57, 10, '2020-12-15 22:33:16', NULL),
(101, 57, 12, '2020-12-15 22:33:16', NULL);
...
(23, 1, 4, 2, '9.00', '2020-11-21 04:14:23', '2020-11-06 15:00:00', '2020-11-21 03:14:23', '2020-11-21 03:14:23');
...
INSERT INTO `reservation_seat` (`id`, `res_id`, `seat_id`, `created_at`, `updated_at`) VALUES
(1, 5, 7, '2020-11-06 20:32:44', NULL),
(12, 23, 10, '2020-11-21 03:14:23', NULL),
(13, 23, 11, '2020-11-21 03:14:23', NULL);
...
INSERT INTO `seat` (`id`, `number`, `free`, `created_at`, `updated_at`) VALUES
(7, 5, 0, '2020-08-16 15:15:49', NULL),
(10, 13, 1, '2020-09-25 12:32:08', NULL),
(11, 14, 1, '2020-09-25 12:32:08', NULL),
(17, 40, 1, '2020-10-04 12:38:16', NULL);
...
(2, 2, 'Watch the new movies', '', '2020-04-25 02:09:12', NULL);
...
(24, 'Moralna Pobedabaa', 'moralnaaa', 'moralnapobedabacaa71@gmail.com', '2020-12-12 15:22:14', '$2y$10$oPL5lPqFVDum3WRr2hnele9KM.37BiaKTxIvzTVjfkuN0C3jGCVAG', 2, '453367593cc51d95e1d3acb6343f028a', NULL, '2020-05-15 22:16:28', '2020-12-12 15:22:14'),
...
(79, 'Nataša Majstorović', '@nataaa', 'nata@gmail.com', '2020-12-09 19:36:34', '$2y$10$zuU9pxmia8UikT2EIwEk9.sIUXr2vPOLHa1SaPSIkhLuu75LwthKe', 2, NULL, NULL, '2020-12-09 19:36:34', '2020-12-09 19:36:34');
...
--
ALTER TABLE `reservation_seat`
  ADD CONSTRAINT `reservation_seat_ibfk_1` FOREIGN KEY (`seat_id`) REFERENCES `seat` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `reservation_seat_ibfk_2` FOREIGN KEY (`res_id`) REFERENCES `reservation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
